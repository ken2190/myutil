...
## @type: DataSource
## @args: [database = "import-sensor-events-database", table_name = "import_sensor_events_bucket", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "import-sensor-events-database", table_name = "import_sensor_events_bucket", transformation_ctx = "datasource0")
...
## @type: DataSink
## @args: [catalog_connection = "redshift", connection_options = {"dbtable": "import_sensor_events_bucket", "database": "mydatabase"}, redshift_tmp_dir = TempDir, transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = dropnullfields3, catalog_connection = "redshift", connection_options = {"dbtable": "import_sensor_events_bucket", "database": "mydatabase"}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink4")
job.commit()